Shader "Light2D/Sprites/Lit"
{
	...
	SubShader
	{
		...
		CGPROGRAM
            ...
            // Cam 1
			uniform sampler2D _Cam1_Texture;
            uniform vector _Cam1_Rect;
            uniform float _Cam1_Rotation;

			 // Cam 2
			uniform sampler2D _Cam2_Texture;
			uniform vector _Cam2_Rect;
            uniform float _Cam2_Rotation;
